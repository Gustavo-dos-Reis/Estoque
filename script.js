function validarProduto(idNomeProduto, idCodProduto, idQtidadeProduto) {
    ...
    if (nome == " ") 
        ...
        alert("Código do produto não pode estar em branco. Favor preenche-lo!");
...
function carregarTotalEstoque(idCampo) {
    ...
    else alert("A versão de seu navegador é muito antiga. Por isso, não será possível executar essa aplicação")
}
